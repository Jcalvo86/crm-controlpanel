  ...
  return (
    <div className="space-y-8 animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {activeModules.map(modKey => {
            ...
            return (
              <div 
                key={modKey} 
                className="glass-panel p-5 flex flex-col justify-between hover:border-[var(--primary)] hover:shadow-lg transition-all border border-[var(--outline)] rounded-xl"
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-[var(--outline)]">
                  <button
                    ...
                    className="btn-secondary w-full justify-center text-xs h-9 rounded-md"
                  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-panel p-6 space-y-4 border border-[var(--outline)] rounded-xl">
          ...
          <div className="flex flex-wrap gap-3">
            <a 
              href="setup.html" 
              className="btn-secondary text-xs flex items-center gap-1 h-9 rounded-md px-4"
